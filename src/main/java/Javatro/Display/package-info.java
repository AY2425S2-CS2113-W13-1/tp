 ...
 *   <li>{@link Javatro.Javatro.View.Screen} - An abstract base class for all screens, providing
 *       common functionalities.
 *   <li>{@link Javatro.Javatro.View.SelectCardsToDiscardScreen} - Allows users to select cards to
 *       discard.
 *   <li>{@link Javatro.Javatro.View.SelectCardsToPlayScreen} - Allows users to select cards to
 *       play.
 *   <li>{@link Javatro.Javatro.View.SelectionScreen} - A screen for selecting game elements,
 *       extended by other selection screens.
 *   <li>{@link Javatro.Javatro.View.StartScreen} - The main menu screen that provides options to
